...
const DocumentVisual = () => {
  return <div className="relative h-full w-full flex items-center justify-center" data-unique-id="eaf514a4-fdab-44d9-a4e3-a72e39b68eea" data-file-name="components/FinancialCarousel.tsx">
      <div className="absolute inset-0 bg-blue-50 rounded-lg" data-unique-id="a71ee785-ab03-4014-8ee9-c649200b040f" data-file-name="components/FinancialCarousel.tsx"></div>
        ...
        backgroundRepeat: "repeat-y"
          ...
          <div className="flex justify-between items-center mb-6 border-b border-gray-300 pb-4" data-unique-id="dd878f75-aa76-4a9c-ab24-e313ab98f453" data-file-name="components/FinancialCarousel.tsx">
            <div data-unique-id="bae0da77-6d4a-41a8-8ea4-16ac91ef9504" data-file-name="components/FinancialCarousel.tsx">
              <div className="text-xl font-bold text-blue-800" data-unique-id="c006e67f-9c7a-4335-bf31-cdc86b4188b9" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="5dbde111-490b-4d84-867f-d4bbbffbbf6c" data-file-name="components/FinancialCarousel.tsx">Quarterly Financial Statement</span></div>
          ...
          <div className="space-y-5" data-unique-id="4eb02131-d855-494e-8f71-ace4cc2d3553" data-file-name="components/FinancialCarousel.tsx">
            ...
            delay: 0.4
              ...
              <div className="grid grid-cols-2 gap-y-2 text-sm" data-unique-id="d28a704e-63e4-490a-8e8d-b6cf2a8f10ed" data-file-name="components/FinancialCarousel.tsx">
                ...
                <div className="text-blue-800 font-medium" data-unique-id="d47dd773-e13a-49f4-b2d4-b0816fa05b16" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="e91b8cf7-d9b5-4312-b842-a69a8e2b7c4e" data-file-name="components/FinancialCarousel.tsx">$142.7 Million</span></div>
                ...
                <div className="text-blue-800 font-medium" data-unique-id="7483b0ca-d206-474b-8f87-1cdfd7ed94bb" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="eb97a8f7-9c3c-4ca4-9461-e8bfc0c7b0d2" data-file-name="components/FinancialCarousel.tsx">$87.3 Million</span></div>
                ...
                <div className="text-blue-800 font-medium" data-unique-id="a96cba86-dbee-452d-a468-94fa427cb913" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="09ebe4e9-279d-42fa-abe6-6f3b2a27ebd3" data-file-name="components/FinancialCarousel.tsx">$38.2 Million</span></div>
                ...
                <div className="text-blue-800 font-medium" data-unique-id="4b5b490d-b1ed-4e0e-8fd6-432311eddef4" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="124dae0c-3036-4362-af0e-36c88e99f32f" data-file-name="components/FinancialCarousel.tsx">$2.47</span></div>
              </div>
            </motion.div>
            ...
            delay: 0.6
              ...
              <div className="grid grid-cols-2 gap-y-2 text-sm" data-unique-id="a08bc4be-58be-4805-97e6-5a8b5502f9f8" data-file-name="components/FinancialCarousel.tsx">
                ...
                <div className="text-blue-800 font-medium" data-unique-id="e8dcf89b-6fab-49e1-be0e-9d2cceb4ac50" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="4478cdd8-6836-4184-b1a6-8684991b8125" data-file-name="components/FinancialCarousel.tsx">$97.2 Million</span></div>
                ...
                <div className="text-blue-800 font-medium" data-unique-id="2ef65cad-d971-4922-aea3-31a38ab5aaf3" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="ea9d94e5-b512-401f-a476-0076113ce736" data-file-name="components/FinancialCarousel.tsx">$42.5 Million</span></div>
                ...
                <div className="text-blue-800 font-medium" data-unique-id="5db39d2b-fdd4-4c3b-a283-a9843a96368f" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="ee3ac3b1-dca5-4e3a-bcb6-7bd45d380796" data-file-name="components/FinancialCarousel.tsx">$12.1 Million</span></div>
                ...
                <div className="text-blue-800 font-medium" data-unique-id="a3a7bffb-32d9-45cf-9bbb-07bff0857a64" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="38608086-e53d-4b97-91f2-bc31d346ef53" data-file-name="components/FinancialCarousel.tsx">$30.4 Million</span></div>
              </div>
            </motion.div>
          </div>
...
const DataTableVisual = () => {
  ...
  return <div className="relative h-full w-full flex items-center justify-center" data-unique-id="ff24b667-3d36-47db-9022-018ca401f3ee" data-file-name="components/FinancialCarousel.tsx">
      <div className="absolute inset-0 bg-blue-50 rounded-lg" data-unique-id="af181fb7-8e26-41dc-af3f-ab6299a2a109" data-file-name="components/FinancialCarousel.tsx"></div>
            ...
            <div className="overflow-x-auto" data-unique-id="719b64e0-6809-4432-a144-737c8345f1c5" data-file-name="components/FinancialCarousel.tsx">
              <table className="w-full" data-unique-id="4405909d-e8d5-4a1c-8f54-5f4db94ed201" data-file-name="components/FinancialCarousel.tsx">
                <thead data-unique-id="ab34471f-287b-4d70-a377-626f8990786e" data-file-name="components/FinancialCarousel.tsx">
                  <tr className="bg-blue-50" data-unique-id="1dbc326b-36fe-48c9-a26f-66788ef3aaac" data-file-name="components/FinancialCarousel.tsx">
                    <th className="px-4 py-3 text-left text-xs font-semibold text-blue-800 uppercase tracking-wider border-b border-gray-200" data-unique-id="ce556720-283a-40b1-994f-def77d6097e1" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="66d39197-a0a0-499c-a165-7816e727430f" data-file-name="components/FinancialCarousel.tsx">
                      Business Unit
                    </span></th>
                    <th className="px-4 py-3 text-right text-xs font-semibold text-blue-800 uppercase tracking-wider border-b border-gray-200" data-unique-id="6f38217d-3aba-49c8-b701-0a4e729eac58" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="850c7386-5682-4f9e-81d5-c4cb28d5351a" data-file-name="components/FinancialCarousel.tsx">
                      Q1
                    </span></th>
                    <th className="px-4 py-3 text-right text-xs font-semibold text-blue-800 uppercase tracking-wider border-b border-gray-200" data-unique-id="9dfc8ec3-f20b-4e6d-a2a5-8894ae868b3b" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="229d4187-3615-4b9a-a782-bbc7a4f7d3d9" data-file-name="components/FinancialCarousel.tsx">
                      Q2
                    </span></th>
                    <th className="px-4 py-3 text-right text-xs font-semibold text-blue-800 uppercase tracking-wider border-b border-gray-200" data-unique-id="5c16f2c7-4208-490d-8477-b4c8676c808e" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="c36c8f89-64ce-412a-960b-39196b659522" data-file-name="components/FinancialCarousel.tsx">
                      Q3
                    </span></th>
                    <th className="px-4 py-3 text-right text-xs font-semibold text-blue-800 uppercase tracking-wider border-b border-gray-200" data-unique-id="edbc4d5d-ff2f-416a-bcb1-57260bb7c95b" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="baed6e67-74e8-4dd2-8d08-3645080c31a1" data-file-name="components/FinancialCarousel.tsx">
                      Q4
                    </span></th>
                    <th className="px-4 py-3 text-right text-xs font-semibold text-blue-800 uppercase tracking-wider border-b border-gray-200" data-unique-id="f183c251-9bd6-4125-a5c0-097e14d9c024" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="a4cc278a-c9b8-4401-a3e4-7073f2d90c7f" data-file-name="components/FinancialCarousel.tsx">
                      Total
                    </span></th>
                    <th className="px-4 py-3 text-right text-xs font-semibold text-blue-800 uppercase tracking-wider border-b border-gray-200" data-unique-id="d24e01c5-9df3-4356-9424-c49c0a22b4b5" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="e86dec77-ce81-4b50-85b6-5810a74a587e" data-file-name="components/FinancialCarousel.tsx">
                      Growth
                    </span></th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200" data-unique-id="7e270339-cb66-4fa9-a3ed-115ce920ac96" data-file-name="components/FinancialCarousel.tsx" data-dynamic-text="true">
                  ...
                  backgroundColor: "rgba(239, 246, 255, 0.5)"
                      ...
                      <td className="px-4 py-3 text-sm text-blue-800 font-medium text-right" data-is-mapped="true" data-unique-id="bb4f3315-7f11-4075-9b51-1e383dcfda30" data-file-name="components/FinancialCarousel.tsx" data-dynamic-text="true"><span className="editable-text" data-is-mapped="true" data-unique-id="d9b6b12a-6a2c-4525-aa03-6c79e1bf9a4e" data-file-name="components/FinancialCarousel.tsx">
                      ...
                      <td className={`px-4 py-3 text-sm text-right font-medium ${row.growth > 15 ? 'text-green-600' : row.growth > 5 ? 'text-blue-600' : 'text-amber-600'}`} data-is-mapped="true" data-unique-id="31a63322-1792-44da-9949-a7ec10583d10" data-file-name="components/FinancialCarousel.tsx" data-dynamic-text="true">
                ...
                <tfoot data-unique-id="bce9af26-45f5-49ca-b948-41b9bc990245" data-file-name="components/FinancialCarousel.tsx">
                  <motion.tr className="bg-blue-50" initial={{
                  opacity: 0
                }} animate={{
                  opacity: 1
                }} transition={{
                  delay: 0.8
                    ...
                    <td className="px-4 py-3 text-sm font-bold text-blue-800" data-unique-id="126806d4-820e-40d9-acda-3700ea2cdd9a" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="12bfdcf1-fcc4-41f1-8a8d-2b9450f98232" data-file-name="components/FinancialCarousel.tsx">
                      Total Revenue
                    </span></td>
                    <td className="px-4 py-3 text-sm font-bold text-blue-800 text-right" data-unique-id="71bfb78f-0340-4210-bbb6-f725a8b7e0f3" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="39d31375-027a-4d0a-b7b2-5933e87440b0" data-file-name="components/FinancialCarousel.tsx">
                      $113.5M
                    </span></td>
                    <td className="px-4 py-3 text-sm font-bold text-blue-800 text-right" data-unique-id="2ecdef21-e535-4d8d-bfd1-adf65b220ba9" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="32c726c9-9fd2-4af1-8cd8-724adfc58a6d" data-file-name="components/FinancialCarousel.tsx">
                      $122.6M
                    </span></td>
                    <td className="px-4 py-3 text-sm font-bold text-blue-800 text-right" data-unique-id="7d773060-4d0f-41fb-8022-5a0de6c4acbf" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="f0eb291a-1038-4472-bd83-f850d7d12136" data-file-name="components/FinancialCarousel.tsx">
                      $142.7M
                    </span></td>
                    <td className="px-4 py-3 text-sm font-bold text-blue-800 text-right" data-unique-id="d2f2cf21-d776-4849-ba2f-6f2bb5cd5fe7" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="d9e40b39-e910-4a81-bf7e-1aaf6168b86e" data-file-name="components/FinancialCarousel.tsx">
                      $159.3M
                    </span></td>
                    <td className="px-4 py-3 text-sm font-bold text-blue-800 text-right" data-unique-id="d5feb9ea-23b4-4a94-8559-d24b613cd650" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="937b532a-8b72-4197-8f9c-d07a51de4965" data-file-name="components/FinancialCarousel.tsx">
                      $538.1M
                    </span></td>
...
const LineChartVisual = () => <div className="relative h-full w-full flex items-center justify-center" data-unique-id="7efdc078-5ad3-42d4-a39d-61294d9b0b24" data-file-name="components/FinancialCarousel.tsx">
    <div className="absolute inset-0 bg-blue-500 bg-opacity-10 rounded-lg" data-unique-id="dde2f3b0-8f87-40a9-922b-b26885e233b6" data-file-name="components/FinancialCarousel.tsx"></div>
...
const InvestmentVisual = () => <div className="relative h-full w-full flex items-center justify-center" data-unique-id="9e754f9e-8116-4b34-b41c-6cb662e82c3a" data-file-name="components/FinancialCarousel.tsx">
    <div className="absolute inset-0 bg-blue-500 bg-opacity-10 rounded-lg" data-unique-id="8b48d56d-f886-452e-913d-f3f6b1822775" data-file-name="components/FinancialCarousel.tsx"></div>
...
const EfficiencyVisual = () => <div className="relative h-full w-full flex items-center justify-center" data-unique-id="ec829a11-a9b5-4cac-9dae-f89267180c00" data-file-name="components/FinancialCarousel.tsx">
    <div className="absolute inset-0 bg-blue-500 bg-opacity-10 rounded-lg" data-unique-id="53cbeba5-11e0-4648-8e46-8d1236511604" data-file-name="components/FinancialCarousel.tsx"></div>
    <div className="relative z-10 flex flex-col items-center justify-center space-y-4 w-full h-full" data-unique-id="69df548e-0547-4e95-b271-beb93c681118" data-file-name="components/FinancialCarousel.tsx">
      <div className="w-full flex justify-around items-end h-48 px-4" data-unique-id="7046723a-c36c-49c9-9f2f-606d7c6f3f23" data-file-name="components/FinancialCarousel.tsx">
        <div className="flex flex-col items-center" data-unique-id="0452f42f-99f8-4816-a6d0-8b0378f37ef4" data-file-name="components/FinancialCarousel.tsx">
          <div className="h-32 w-16 bg-gradient-to-t from-blue-600 to-blue-400 rounded-t-md relative" data-unique-id="31dfd3c9-dccc-454b-b7d8-c8963bbf86ce" data-file-name="components/FinancialCarousel.tsx">
            <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 -translate-y-full bg-blue-800 text-white px-2 py-1 rounded text-xs" data-unique-id="41560cbd-3461-41a3-b64f-307dd67b77d2" data-file-name="components/FinancialCarousel.tsx"><span className="editable-text" data-unique-id="7197a79e-16f6-4e9a-822f-b4546185c2d0" data-file-name="components/FinancialCarousel.tsx">Current</span></div>
          </div>
        ...
        <div className="flex flex-col items-center" data-unique-id="ab318fcd-537e-427e-a29c-78344bfde44b" data-file-name="components/FinancialCarousel.tsx">
          <div className="h-32 w-16 relative" data-unique-id="9905f4eb-9acb-4b24-8522-6b00dd4591ad" data-file-name="components/FinancialCarousel.tsx">
            <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-blue-600 to-blue-400 rounded-t-md" data-unique-id="37f6429a-7514-4220-acba-88db4685c804" data-file-name="components/FinancialCarousel.tsx"></div>
        ...
        <div className="flex flex-col items-center" data-unique-id="a9ec3fb1-8fb3-4825-8594-113c1c47a324" data-file-name="components/FinancialCarousel.tsx">
          <div className="h-32 w-16 relative" data-unique-id="cb56ae50-042b-4e86-9bd8-028789dbc689" data-file-name="components/FinancialCarousel.tsx">
            <div className="absolute bottom-0 left-0 right-0 h-28 bg-gradient-to-t from-blue-600 to-blue-400 rounded-t-md" data-unique-id="4fd755a5-09fe-4f63-9ec8-49cbe651eeee" data-file-name="components/FinancialCarousel.tsx"></div>
        ...
        <AnimatePresence initial={false} custom={direction} mode="wait">
          ...
          opacity: {
            ...
            <div className="w-1/2 bg-white p-6 rounded-r-xl shadow-md" data-unique-id="47d66e79-6a21-4e66-a4dc-d3a964bd63e9" data-file-name="components/FinancialCarousel.tsx">
              <div className="h-full flex flex-col justify-center p-6 rounded-lg border border-blue-100" style={holographicEffect} data-unique-id="0a2873cd-ab19-4040-bfc6-1808b49daa8d" data-file-name="components/FinancialCarousel.tsx">
                <div className="mb-4 flex items-center" data-unique-id="bf4d5ad0-8388-45aa-9aab-2c72303c9209" data-file-name="components/FinancialCarousel.tsx">
                ...
                }} className="text-blue-500 mr-2" data-unique-id="f630d57a-a963-4d45-ac1c-435287f8a199" data-file-name="components/FinancialCarousel.tsx" data-dynamic-text="true">
                  ...
                  <h3 className="text-lg font-medium text-blue-800" data-unique-id="11306408-f1de-476a-8d7c-666c628f97cf" data-file-name="components/FinancialCarousel.tsx">
                ...
                <div className="text-gray-700 leading-relaxed relative min-h-[120px]" data-unique-id="1e196ca6-6063-46b0-bacf-5db64515cbf7" data-file-name="components/FinancialCarousel.tsx" data-dynamic-text="true">
                  ...
                  duration: 0.8
                        ...
                        <motion.div className="h-4 bg-blue-100 rounded w-full max-w-[80%]" animate={{
                    opacity: [0.4, 0.8, 0.4]
                  }} transition={{
                    duration: 1.5,
                    repeat: Infinity,
                    repeatType: "reverse"
                        ...
                        <motion.div className="h-4 bg-blue-100 rounded w-full max-w-[90%]" animate={{
                    opacity: [0.3, 0.7, 0.3]
                  }} transition={{
                    duration: 1.7,
                    repeat: Infinity,
                    ...
                    delay: 0.2
                        ...
                        <motion.div className="h-4 bg-blue-100 rounded w-full max-w-[70%]" animate={{
                    opacity: [0.5, 0.9, 0.5]
                  }} transition={{
                    duration: 1.3,
                    repeat: Infinity,
                    ...
                    delay: 0.4
                        ...
                        <motion.div className="text-blue-500 text-sm mt-2 flex items-center" data-unique-id="8229cba1-2ee1-4711-9364-595c880882a0" data-file-name="components/FinancialCarousel.tsx">
                      ...
                      </div> : <motion.div className="text-blue-400 text-center py-6 italic" animate={{
                  opacity: [0.7, 1, 0.7]
                }} transition={{
                  duration: 2,
                  repeat: Infinity,
                  ...
                  {currentData[currentSlide].insightGenerating && <motion.div className="absolute inset-0 bg-blue-400 bg-opacity-5" animate={{
                  opacity: [0, 0.3, 0],
                  x: [0, 2, 0, -2, 0]
                }} transition={{
                  duration: 0.5,
