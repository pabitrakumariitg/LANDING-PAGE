  ...
  return <div className="flex flex-col space-y-3" data-unique-id="cf0b6dc3-a2b6-439e-bf78-be73ee05afad" data-file-name="components/AIModelSelector.tsx" data-dynamic-text="true">
      <div className="flex items-center justify-between" data-unique-id="292913eb-dfe1-47f4-a49a-295cee285d60" data-file-name="components/AIModelSelector.tsx">
        <div className="flex items-center" data-unique-id="8ff9613d-236a-4d9f-9e35-a4883dd1f2b1" data-file-name="components/AIModelSelector.tsx">
          {/* <span className="text-sm text-[#415d80] mr-2" data-unique-id="a99df669-84d9-45c3-9b56-5384e8d5ecfd" data-file-name="components/AIModelSelector.tsx"><span className="editable-text" data-unique-id="d55eed42-6fd9-4615-84e5-42f2a09680af" data-file-name="components/AIModelSelector.tsx">AI Model:</span></span> */}
          {/* <select value={selectedModel} onChange={e => setSelectedModel(e.target.value)} className="bg-white text-[#415d80] text-sm rounded-md border border-[#415d80] border-opacity-20 px-2 py-1" data-unique-id="2ac61a54-0f83-41e5-b2ac-0d33873a4e06" data-file-name="components/AIModelSelector.tsx" data-dynamic-text="true">
